...
if (isset($_POST["email"]) && isset($_POST["password"])){
	...
	if ($account) {
		if (password_verify($password, $account['team_password'])) {
			...
			$_SESSION['tier_1'] = (string)$account["tier_1"];
			$_SESSION['tier_2'] = (string)$account["tier_2"];
			$_SESSION['tier_3'] = (string)$account["tier_3"];
			$_SESSION['tier_4'] = (string)$account["tier_4"];
			$_SESSION['tier_5'] = (string)$account["tier_5"];
			echo 1;
			exit; 
